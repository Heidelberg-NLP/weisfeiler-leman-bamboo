...
Thanks for visting this project page that accompanies our [TACL paper](https://transacl.org/index.php/tacl/article/view/3073).

- Please come along [this way into the BAMBOO](https://github.com/flipz357/bamboo-amr-benchmark).

- And [this way to the AMR metrics](https://github.com/flipz357/weisfeiler-leman-amr-metrics).

## Citation

If you like this work, consider citing:
